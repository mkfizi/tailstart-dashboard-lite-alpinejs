/**
 * --------------------------------------------------------------------------
 * Tailstart - Dashboard Lite (AlpineJS) v0.1.0: app.js
 * Licensed under MIT (https://github.com/mkfizi/tailstart-dashboard-lite-alpinejs/blob/main/LICENSE)
 * --------------------------------------------------------------------------
 */
...
(function () {
    ...
    app.name = 'Tailstart - Dashboard Lite (AlpineJS)';
    app.version = '0.1.0';
